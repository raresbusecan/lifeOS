...
export async function indexContent(repositoryRoot) {
    ...
    for (const file of files) {
        ...
        const result = await getOrCreateContentCache(repositoryRoot, file.path, content);
...
export function formatContentIndexResult(result) {
    return [
        "",
