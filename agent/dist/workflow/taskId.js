export function createTaskId(sequence) {
...
export function createChildTaskId(parentTaskId, sequence) {
    ...
    if (!Number.isInteger(sequence) ||
        sequence <= 0) {
        throw new Error("Child task sequence must be a positive integer.");
    }
