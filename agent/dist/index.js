...
console.log(`Project state: ${existsSync(stateFile) ? "OK" : "MISSING"}`);
console.log(`Instructions: ${existsSync(instructionsFile) ? "OK" : "MISSING"}`);
console.log(`Agent workspace: ${existsSync(agentDirectory) ? "OK" : "MISSING"}`);
console.log("");
